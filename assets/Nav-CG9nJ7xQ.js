...
`,z=e.span`
  ...
  animation: ${p} 10s ease-in-out forwards;
  z-index: 998;
...
`;function O({hidden:x=!1}){const[m,u]=i.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(max-width: 900px)").matches),[l,n]=i.useState(!1);return i.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const o=window.matchMedia("(max-width: 900px)"),d=()=>{u(o.matches),o.matches||n(!1)};return d(),o.addEventListener("change",d),()=>{o.removeEventListener("change",d)}},[]),i.useEffect(()=>{if(!l)return;const o=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=o}},[l]),x?null:t.jsxs(j,{children:[t.jsx(s,{to:"/",style:{cursor:"none"},children:t.jsx(F,{src:b})}),t.jsxs(X,{children:[t.jsxs(E,{children:[t.jsxs(h,{children:[m?t.jsx(g,{role:"button",tabIndex:0,onClick:()=>n(!0),onKeyDown:o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),n(!0))},style:{cursor:"pointer"},children:"Art"}):t.jsx(g,{children:"Art"}),t.jsxs(Y,{children:[t.jsx(r,{to:"/dwelling",children:"Dwelling"}),t.jsx(r,{to:"/composition",children:"Composition"}),t.jsx(A,{}),t.jsx(r,{to:"/printmaking",children:"Printmaking"}),t.jsx(r,{to:"/photography",children:"Photography"}),t.jsx(r,{to:"/3d",children:"3D + Graffiti"})]})]}),t.jsx(h,{children:t.jsx(S,{to:"/About",children:"About"})})]}),t.jsxs(M,{children:[t.jsx(z,{}),t.jsx(C,{}),t.jsx(L,{}),t.jsx(y,{}),t.jsx(v,{})]})]}),m&&l?t.jsxs(N,{children:[t.jsx(P,{type:"button","aria-label":"Close menu",onClick:()=>n(!1),children:"×"}),t.jsx(a,{to:"/dwelling",onClick:()=>n(!1),children:"Dwelling"}),t.jsx(a,{to:"/composition",onClick:()=>n(!1),children:"Composition"}),t.jsx(a,{to:"/printmaking",onClick:()=>n(!1),children:"Printmaking"}),t.jsx(a,{to:"/photography",onClick:()=>n(!1),children:"Photography"}),t.jsx(a,{to:"/3d",onClick:()=>n(!1),children:"3D + Graffiti"}),t.jsx(a,{to:"/about",onClick:()=>n(!1),children:"About"})]}):null]})}export{O as default};
