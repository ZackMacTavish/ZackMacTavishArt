...
`,Kt=c.div`
  ...
  text-align: center;
`,Jt=g.forwardRef(function({page:T,index:S,bookTitle:f},b){const A=S===0||T.isLast;return n.jsx(Vt,{ref:b,"data-density":S===0||T.isLast?"hard":"soft","data-cursor-hover":!0,children:n.jsx(Yt,{src:T.src,alt:S===0?`${f} front cover`:T.isLast?`${f} back cover`:`${f} page ${S+1}`,width:T.width,height:T.height,loading:S<4?"eager":"lazy",draggable:"false",$isCover:A})})});function Qt({assetDirectory:o="composition-book",bookTitle:T="Composition art book"}){const S=g.useRef(null),f=g.useRef(null),b=g.useRef(null),A=g.useRef(!1),[R,m]=g.useState([]),[I,P]=g.useState(0),[D,w]=g.useState(!1),[G,U]=g.useState(!1),[W,X]=g.useState(!1),[K,q]=g.useState(!1),[J,h]=g.useState(0),[t,e]=g.useState(gt),[i,s]=g.useState(""),a=I===0,r=R.length>0&&I===R.length-1,l=a&&!D||G;g.useEffect(()=>{const p=new AbortController,C=`/${o}/`;return fetch(`${C}manifest.json`,{signal:p.signal}).then(M=>{if(!M.ok)throw new Error("The book could not be loaded.");return M.json()}).then(M=>{m(M.pages.map((O,Z)=>({...O,src:`${C}${O.file}`,isLast:Z===M.pages.length-1})))}).catch(M=>{M.name!=="AbortError"&&s(M.message)}),()=>p.abort()},[o]),g.useLayoutEffect(()=>{const p=b.current;if(!p)return;const C=()=>{const O=p.getBoundingClientRect(),Z=(O.left+O.right)/2;h(Math.round(Z)-Z)};C();const M=new ResizeObserver(C);return M.observe(p),window.addEventListener("resize",C),()=>{M.disconnect(),window.removeEventListener("resize",C)}},[]),g.useEffect(()=>{let p;const C=()=>{window.clearTimeout(p),p=window.setTimeout(()=>e(gt()),120)};return window.addEventListener("resize",C),()=>{window.clearTimeout(p),window.removeEventListener("resize",C)}},[]),g.useEffect(()=>{const p=()=>{const C=document.fullscreenElement===f.current,M=A.current&&!C;A.current=C,X(C),M&&requestAnimationFrame(()=>{f.current?.scrollIntoView({block:"center",inline:"nearest"})})};return document.addEventListener("fullscreenchange",p),()=>document.removeEventListener("fullscreenchange",p)},[]);const d=()=>S.current?.pageFlip(),u=()=>d()?.turnToPage(0),x=()=>{I===1&&U(!0),d()?.flipPrev("top")},j=()=>{a&&w(!0),d()?.flipNext("top")},L=p=>{p.key==="ArrowLeft"&&(p.preventDefault(),x()),p.key==="ArrowRight"&&(p.preventDefault(),j())},bt=async()=>{document.fullscreenElement?await document.exitFullscreen():await f.current?.requestFullscreen()};return n.jsxs(qt,{ref:f,"aria-label":`${T} flip through`,children:[n.jsxs(Zt,{ref:b,tabIndex:0,onKeyDown:L,$isFullscreen:W,$isFlipping:K,$isSinglePage:l||r,$coverPosition:l?"front":r?"back":"open",$pixelOffset:J,children:[i&&n.jsx(pt,{role:"alert",children:i}),!i&&R.length===0&&n.jsx(pt,{role:"status",children:"Loading book..."}),R.length>0&&n.jsx(Wt,{ref:S,startPage:I,width:424,height:600,size:"stretch",minWidth:120,maxWidth:W?600:Math.round(t*Ut),minHeight:170,maxHeight:W?849:t,drawShadow:!1,showCover:!0,usePortrait:!1,mobileScrollSupport:!0,swipeDistance:24,flippingTime:700,onFlip:p=>P(p.data),onChangeState:p=>{p.data==="flipping"&&(q(!0),a&&w(!0)),p.data==="read"&&(q(!1),w(!1),U(!1))},className:"book-flipbook",children:R.map((p,C)=>n.jsx(Jt,{page:p,index:C,bookTitle:T},p.file))},W?"fullscreen":`embedded-${t}`)]}),R.length>0&&n.jsxs(Xt,{"aria-label":"Book controls",$isFullscreen:W,$isSinglePage:l||r,$coverPosition:l?"front":r?"back":"open",children:[n.jsx(V,{type:"button",onClick:u,disabled:I===0,"aria-label":"First page",title:"First page",children:n.jsx(Lt,{"aria-hidden":"true",size:22})}),n.jsx(V,{type:"button",onClick:x,disabled:I===0,"aria-label":"Previous page",title:"Previous page",children:n.jsx(Ot,{"aria-hidden":"true",size:22})}),n.jsxs(Kt,{"aria-live":"polite",children:["Page ",I+1," of ",R.length]}),n.jsx(V,{type:"button",onClick:j,disabled:I>=R.length-1,"aria-label":"Next page",title:"Next page",children:n.jsx(Ft,{"aria-hidden":"true",size:22})}),n.jsx(V,{type:"button",onClick:bt,"aria-label":W?"Exit fullscreen":"View fullscreen",title:W?"Exit fullscreen":"View fullscreen",children:W?n.jsx(Gt,{"aria-hidden":"true",size:20}):n.jsx(_t,{"aria-hidden":"true",size:20})})]})]})}const te="/assets/Composition-BackCover-Pt.2-01-CgJGr0YY.jpg",mt="/assets/Composition-BackCover-Pt.2-01-ClPDHp8f.webp",ut="/assets/Composition-BackCover-Pt.2-01-Brw18o1R.avif",ee="/assets/Composition-BackCover-Pt.2-01-640-hLwNqpV9.webp",ie="/assets/Composition-BackCover-Pt.2-01-960-0YCK3KpW.webp",se="/assets/Composition-BackCover-Pt.2-01-640-DJc-I_AQ.avif",ne="/assets/Composition-BackCover-Pt.2-01-960-DjxWYxI5.avif",ae="/assets/Render1-DT-g5NKH.png",oe="/assets/Render1-CPYa-0q4.webp",re="/assets/Render1-DOs6TUJE.avif",ft="/assets/Artbook-CTrBke0P.png",wt="/assets/Artbook-4LqNfgyx.webp",xt="/assets/Artbook-qr5jOApA.avif",he="/assets/Composition-Etching-2026-y8EAzUrN.jpg",le="/assets/Composition-Etching-2026-DRtZwhGl.webp",de="/assets/Composition-Etching-2026-DPeLH0oV.avif",ce="/assets/Orbital-Me_evN6P.jpg",ge="/assets/Orbital-MSHexiyD.webp",pe="/assets/Orbital-kkd1dZ4d.avif",me="/assets/Spraypaintwash-BbPvaVYI.png",ue="/assets/Spraypaintwash-BaOYkJyw.webp",fe="/assets/Spraypaintwash-v7LuXuaa.avif",we="/assets/Render2-BeFVEg4T.png",xe="/assets/Render2-BFuydU6r.webp",ve="/assets/Render2-DoNAMUHJ.avif",ye="/assets/Twin1-D2RWvRgs.jpeg",be="/assets/Twin1-Ekj5P1xU.webp",Pe="/assets/Twin1-BsV_5Kc4.avif",Se="/assets/Twin2-CDf_Ciy4.jpeg",Ce="/assets/Twin2-Ct4ksB9p.webp",ke="/assets/Twin2-DIgZcP_8.avif",Te="/assets/Staircases-X99gJTOY.jpg",Ie="/assets/Staircases-rPaNQ9T8.webp",Ae="/assets/Staircases-CntQHqy2.avif",Re="/assets/heartwhite-hmQhQCSU.jpeg",je="/assets/heartwhite-BY7Arldd.webp",Me="/assets/heartwhite-Deen9ZYa.avif",De="/assets/heartblack-BNrbkkGC.jpg",Be="/assets/heartblack-BDj6PpTZ.webp",We="/assets/heartblack-BM5GOsEM.avif",Ee="/assets/Birds-BRR20DEX.jpg",Le="/assets/Birds-BfTLwFSA.webp",$e="/assets/Birds-CpIRV6cj.avif",Oe="/assets/Brooklyn-pKXeBM0d.jpg",ze="/assets/Brooklyn-CDo2RsPc.webp",Fe="/assets/Brooklyn-B3Xxez07.avif",He="/assets/Coney-XynOADlt.jpg",_e="/assets/Coney-amO18Ojw.webp",Ne="/assets/Coney-BbkJzuhU.avif",Ge="/assets/Brooklyn2-BVlZQUhO.jpg",Ue="/assets/Brooklyn2-BOjlmPf4.webp",qe="/assets/Brooklyn2-hysoQXg9.avif",Ze="/assets/Render4-CUv_OZcU.png",Ve="/assets/Render4-BbP-SCPU.webp",Ye="/assets/Render4-czE6f-R8.avif",Xe="/assets/Rug-Do3b2lPl.jpg",Ke="/assets/Rug-DNTpYrqu.webp",Je="/assets/Rug-qk7_00KP.avif",Qe="/assets/Mash1-C6rAcNzX.png",ti="/assets/Mash1-By186HQs.webp",ei="/assets/Mash1-CD7JNTpE.avif",ii="/assets/Mash2-Dqi8iSdT.png",si="/assets/Mash2-BhSatqSs.webp",ni="/assets/Mash2-DatWVgGz.avif",ai="/assets/Render5-DDVrXzlj.png",oi="/assets/Render5-8-OqZTM_.webp",ri="/assets/Render5-D__NT6lp.avif",hi="/assets/Mash3-hEAJGZMt.png",li="/assets/Mash3-CfssUcL-.webp",di="/assets/Mash3-BzVVQDAv.avif",ci="/assets/Mash4-DJRwDavu.png",gi="/assets/Mash4-voIqPWzH.webp",pi="/assets/Mash4-CfZ6Zm83.avif",mi="/assets/Mattos-cG9NEt7H.png",ui="/assets/Mattos-DpEAIyko.webp",fi="/assets/Mattos-CvCWgofy.avif",wi="/assets/No.3-C03FbQUH.png",xi="/assets/No.3-DZfy37SG.webp",vi="/assets/No.3-DYCAAtZK.avif",yi="/assets/Grain-BEUj0pKY.jpg",bi="/assets/Grain-gPTL1VTa.webp",Pi="/assets/Grain-DXHUqFdd.avif",vt=["https://dribbble.com/Zmactavish","https://www.instagram.com/zackmichaelmactavish","https://www.linkedin.com/in/zacharymactavish/","https://github.com/ZackMacTavish","https://medium.com/@zmactavish"],Si=c.div`
  display: flex;
  justify-content: center;
  align-items: center;
...
`;function _i(){g.useLayoutEffect(()=>{window.scrollTo(0,0)},[]);const o=St(Tt());return n.jsxs("div",{children:[n.jsx("style",{children:`
...
`}),n.jsx(Ct,{title:"Composition | Zack MacTavish Art & Design",description:"Composition is Zack MacTavish's first solo show, using the composition notebook as a metaphor for self-reflection through paintings, photographs, collages, rugs, and a self-published book made from 2019 to 2021.",image:Pt,url:o,keywords:["composition","painting","render","photography"],authorName:"Zack MacTavish",authorAlternateNames:["Zachary MacTavish","Zack MacTavish Art","Zachary MacTavish Art"],sameAs:vt,favicons:[{rel:"icon",sizes:"16x16",href:st},{rel:"icon",sizes:"32x32",href:nt},{rel:"icon",sizes:"256x256",href:at},{rel:"icon",sizes:"512x512",href:Q},{rel:"apple-touch-icon",sizes:"180x180",href:ot},{rel:"icon",sizes:"192x192",href:rt},{rel:"icon",sizes:"512x512",href:Q},{rel:"icon",type:"image/png",sizes:"16x16",href:st},{rel:"icon",type:"image/png",sizes:"32x32",href:nt},{rel:"apple-touch-icon",sizes:"180x180",href:ot},{rel:"icon",type:"image/png",sizes:"192x192",href:rt},{rel:"icon",type:"image/png",sizes:"256x256",href:at},{rel:"icon",type:"image/png",sizes:"512x512",href:Q},{rel:"icon",href:"/favicon.ico"}],jsonLd:{"@context":"https://schema.org","@type":"CreativeWork",name:"Composition Series",url:o,author:{"@type":"Person",name:"Zack MacTavish",alternateName:["Zachary MacTavish","Zack MacTavish Art","Zachary MacTavish Art"],sameAs:vt}}}),n.jsx("h1",{style:kt,children:"Composition by Zack MacTavish"}),n.jsx(Si,{children:n.jsx(Ci,{as:B,src:te,webpSrc:mt,webpSrcSet:`${ee} 640w, ${ie} 960w, ${mt} 2200w`,avifSrc:ut,avifSrcSet:`${se} 640w, ${ne} 960w, ${ut} 2200w`,sizes:"(max-width: 850px) 80vw, 54vw",alt:"Composition notebook cover",width:5620,height:3685,loading:"eager",decoding:"sync",fetchPriority:"high"})}),n.jsxs(ht,{style:{flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"2rem"},children:[n.jsx(lt,{style:{width:"min(88vw, 72ch)",padding:0,alignItems:"stretch"},children:n.jsx(dt,{style:{maxWidth:"100%"},children:"Composition was my first solo art show and uses the composition notebook as a metaphor for self-reflection across the places I have lived. The series grew out of moving more than 21 times through Rhode Island, Massachusetts, Illinois, New York, Oregon, and Pennsylvania, and became a way to document how environment, memory, and personal growth accumulate over time. Made between 2019 and 2021, the show brought together paintings, a graphite drawing, hand-tufted rugs, photographs, physical and digital collages, and a self-published book."})}),n.jsxs(ki,{href:"https://medium.com/@zmactavish/my-first-solo-art-show-de7ac72b054f",target:"_blank",rel:"noreferrer",children:[n.jsx(Ti,{as:B,src:ft,webpSrc:wt,avifSrc:xt,alt:"Composition art book and blog post preview"}),n.jsxs(Ii,{children:[n.jsx(Ai,{children:"Read more about Composition"}),n.jsx(Ri,{children:"A short essay on the show, the series, and how it led into my current body of work."}),n.jsx(ji,{children:"Read on Medium"})]})]})]}),n.jsx(z,{children:n.jsx(F,{as:B,src:ae,webpSrc:oe,avifSrc:re,alt:"Composition render one"})}),n.jsxs("div",{style:{backgroundColor:"var(--surface-secondary)",width:"100%",padding:"var(--space-section-spacious) 0"},children:[n.jsx(k,{className:"tight-split",imageSrc:ft,imageWebp:wt,imageAvif:xt,imageAlt:"Composition artist book",children:n.jsx(Hi,{children:"I self-published a limited edition book for Composition. All 30 copies sold during the run of the series, and the book extended the exhibition's interest in journaling, documentation, and building an archive around the work."})}),n.jsx("div",{style:{width:"100%",background:"var(--surface-secondary)",padding:"var(--space-section-compact) 0"},children:n.jsx(Qt,{})})]}),n.jsxs(E,{children:[n.jsxs(k,{imageMode:"framed",imageSrc:he,imageWebp:le,imageAvif:de,imageAlt:"Untitled etching by Zachary MacTavish, 2026",children:[n.jsx(v,{children:"UNTITLED ETCHING"}),n.jsx(y,{children:"2026"}),n.jsx(yt,{children:"Etching"})]}),n.jsxs(k,{imageMode:"framed",imageSrc:ce,imageWebp:ge,imageAvif:pe,imageAlt:"ORBITAL mixed-media work from Composition",children:[n.jsx(v,{children:"ORBITAL"}),n.jsx(y,{children:"2021"})]}),n.jsxs(k,{imageMode:"framed",imageSrc:me,imageWebp:ue,imageAvif:fe,imageAlt:"Erasure 1",children:[n.jsx(v,{children:"ERASURE I"}),n.jsx(y,{children:"2021"})]})]}),n.jsx(z,{children:n.jsx(F,{as:B,src:we,webpSrc:xe,avifSrc:ve,alt:"Composition render 2"})}),n.jsx(E,{children:n.jsxs(k,{imageMode:"framed",imageSrc:Te,imageWebp:Ie,imageAvif:Ae,imageAlt:"Staircases",children:[n.jsx(v,{children:"STAIRCASES"}),n.jsx(y,{children:"2021"})]})}),n.jsxs(et,{children:[n.jsx($,{as:B,src:Re,webpSrc:je,avifSrc:Me,alt:"Composition X detail white"}),n.jsx(Y,{as:B,src:De,webpSrc:Be,avifSrc:We,alt:"Composition X detail black"}),n.jsxs(tt,{children:[n.jsx(v,{children:"COMPOSITION X"}),n.jsx(y,{children:"2021"})]})]}),n.jsx(B,{src:Ee,webpSrc:Le,avifSrc:$e,alt:"Birds composition",style:{width:"100vw",height:"100vh",objectFit:"cover",objectPosition:"center",display:"block"}}),n.jsxs(E,{children:[n.jsxs(k,{imageSrc:He,imageWebp:_e,imageAvif:Ne,imageAlt:"Coney Island, NY",children:[n.jsx(v,{children:"CONEY ISLAND, NY"}),n.jsx(y,{children:"2021"})]}),n.jsxs(k,{imageSrc:Oe,imageWebp:ze,imageAvif:Fe,imageAlt:"Brooklyn, NY I",children:[n.jsx(v,{children:"BROOKLYN, NY I"}),n.jsx(y,{children:"2021"})]}),n.jsxs(k,{imageSrc:Ge,imageWebp:Ue,imageAvif:qe,imageAlt:"Brooklyn, NY II",children:[n.jsx(v,{children:"BROOKLYN, NY II"}),n.jsx(y,{children:"2021"})]})]}),n.jsx(z,{children:n.jsx(F,{as:B,src:Ze,webpSrc:Ve,avifSrc:Ye,alt:"Composition render 4"})}),n.jsx(E,{children:n.jsxs(k,{imageSrc:Xe,imageWebp:Ke,imageAvif:Je,imageAlt:"Rug I",children:[n.jsx(v,{children:"RUG I"}),n.jsx(y,{children:"2021"})]})}),n.jsxs(E,{children:[n.jsxs(k,{imageMode:"framed",imageSrc:Qe,imageWebp:ti,imageAvif:ei,imageAlt:"Composition III",children:[n.jsx(v,{children:"COMPOSITION III"}),n.jsx(y,{children:"2019"})]}),n.jsxs(k,{imageMode:"framed",imageSrc:ii,imageWebp:si,imageAvif:ni,imageAlt:"Composition IV",children:[n.jsx(v,{children:"COMPOSITION IV"}),n.jsx(y,{children:"2019"})]})]}),n.jsx(z,{children:n.jsx(F,{as:B,src:ai,webpSrc:oi,avifSrc:ri,alt:"Composition render 5"})}),n.jsxs(E,{children:[n.jsxs(k,{imageMode:"framed",imageSrc:hi,imageWebp:li,imageAvif:di,imageAlt:"Composition V",children:[n.jsx(v,{children:"COMPOSITION V"}),n.jsx(y,{children:"2019"})]}),n.jsxs(k,{imageMode:"framed",imageSrc:ci,imageWebp:gi,imageAvif:pi,imageAlt:"Composition VI",children:[n.jsx(v,{children:"COMPOSITION VI"}),n.jsx(y,{children:"2019"})]}),n.jsxs(k,{imageMode:"framed",imageSrc:Rt,imageWebp:At,imageAvif:It,imageAlt:"Composition VII",children:[n.jsx(v,{children:"COMPOSITION VII"}),n.jsx(y,{children:"2020"})]})]}),n.jsx(z,{children:n.jsx(F,{as:B,src:mi,webpSrc:ui,avifSrc:fi,alt:"Mattos collage"})}),n.jsx(E,{children:n.jsxs(k,{imageMode:"framed",imageSrc:wi,imageWebp:xi,imageAvif:vi,imageAlt:"Composition I",children:[n.jsx(v,{children:"COMPOSITION I"}),n.jsx(y,{children:"2018"})]})}),n.jsx(E,{children:n.jsxs(k,{imageMode:"framed",imageSrc:yi,imageWebp:bi,imageAvif:Pi,imageAlt:"GRAIN mixed-media work from Composition",children:[n.jsx(v,{children:"GRAIN"}),n.jsx(y,{children:"2021"})]})}),n.jsxs(et,{children:[n.jsx($,{as:B,src:ye,webpSrc:be,avifSrc:Pe,alt:"Ephemeral I"}),n.jsx(Y,{as:B,src:Se,webpSrc:Ce,avifSrc:ke,alt:"Ephemeral II"}),n.jsxs(tt,{children:[n.jsx(v,{children:"EPHEMERAL I & II"}),n.jsx(y,{children:"2021"})]})]}),n.jsx(ht,{children:n.jsx(lt,{children:n.jsx(dt,{children:"Over the course of Composition, I started to understand that the work was pointing me beyond transition itself and toward the more permanent fixtures that shape a life: the homes I have lived in, the people around me, and the hidden histories carried by those spaces. That realization became the foundation for my current body of work, which turns more fully toward quilting, embroidery, collage, painting, and bookmaking as forms of archive. What Composition began to explore through notebooks, photographs, and fragments of place has expanded into a longer investigation of family, memory, identity, and preservation."})})})]})}const Xi=Object.freeze(Object.defineProperty({__proto__:null,ArtDesc:yt,ArtHeader:v,ArtSectionThreeone:Oi,ArtSectionThreetwo:$i,ArtSectionthree:Ei,ArtSectionthreeog:Li,ArtSectiontwins:et,ArtText:it,ArtTextthree:Fi,ArtTexttwo:zi,ArtYear:y,FullBg:Bi,GridRowThree:Di,GridRowTwo:Mi,Orbital:$,ParagraphFour:Wi,TwinTwo:Y,TwinsText:tt,default:_i},Symbol.toStringTag,{value:"Module"}));export{v as A,Qt as B,Xi as C,Bi as F,Wi as P,y as a,yt as b};
