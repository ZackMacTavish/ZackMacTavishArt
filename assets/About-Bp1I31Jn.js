const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/three-B1QBpFND.js","assets/react-three-BKJczYnz.js","assets/three-BgQdTZ1w.js","assets/index-C0yBYRFJ.js","assets/index-YIlnlg-K.css","assets/website-logoresolutions-1200x630-BPEdvRQz.js","assets/seo-CO2rvSk5.js","assets/ResponsiveImage-ER0KLJEM.js"])))=>i.map(i=>d[i]);
import{l as i,u as b,_ as y,p as k}from"./index-C0yBYRFJ.js";import{b as a,j as t}from"./react-three-BKJczYnz.js";import{f as z,a as j,b as S,i as T,c as A,d as M,o as $}from"./website-logoresolutions-1200x630-BPEdvRQz.js";import{c as W,S as P,v as Z,N as d,I as c}from"./seo-CO2rvSk5.js";import{R as _}from"./ResponsiveImage-ER0KLJEM.js";const B="/assets/Me-BEhJ50qd.jpeg",l="/assets/Me-BZTy2liT.webp",m="/assets/Me-BSjk50SP.avif",E="/assets/Me-640-Bi9OgEeh.webp",H="/assets/Me-960-Bw29gW64.webp",G="/assets/Me-640-BmtY4yVB.avif",C="/assets/Me-960-D42P_fb-.avif",D="/assets/BlackTurtleneck-popart-01-Cfcb3PF3.jpg",I="/assets/BlackTurtleneck-popart-01-Daztt7du.webp",L="/assets/BlackTurtleneck-popart-01-BjHX9soD.avif",q="/assets/hangingquilts-CSgyMA7c.jpg",F="/assets/hangingquilts-BTrRmVGW.webp",N="/assets/hangingquilts-D4aaEPK3.avif",O=a.lazy(()=>y(()=>import("./three-B1QBpFND.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]))),p=["https://dribbble.com/Zmactavish","https://www.instagram.com/zackmichaelmactavish","https://www.linkedin.com/in/zacharymactavish/","https://github.com/ZackMacTavish","https://medium.com/@zmactavish"];i.div`
display: flex;
align-items: center;
...
`,ce=()=>{const[e,h]=a.useState(!0),[o,g]=a.useState(!1),[f,w]=a.useState(()=>typeof window>"u"?!1:window.innerWidth>900),[x,v]=a.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!0:!window.matchMedia("(prefers-reduced-motion: reduce)").matches),u=b(),r=W(u);return a.useLayoutEffect(()=>{window.scrollTo(0,0)},[]),a.useEffect(()=>{const n=()=>{!o&&window.scrollY>50&&(h(!1),g(!0))};window.addEventListener("scroll",n);const s=()=>{w(window.innerWidth>900),v(!window.matchMedia("(prefers-reduced-motion: reduce)").matches)};return window.addEventListener("resize",s),()=>{window.removeEventListener("scroll",n),window.removeEventListener("resize",s)}},[o]),t.jsxs("div",{children:[t.jsx(P,{title:"About | Zack MacTavish Art & Design",description:"About Zack MacTavish, an artist and product designer based in Philadelphia, PA.",image:$,url:r,keywords:["about","artist","product designer","Philadelphia"],authorName:"Zack MacTavish",authorAlternateNames:["Zachary MacTavish","Zack MacTavish Art","Zachary MacTavish Art"],sameAs:p,favicons:[{rel:"icon",type:"image/png",sizes:"16x16",href:z},{rel:"icon",type:"image/png",sizes:"32x32",href:j},{rel:"apple-touch-icon",sizes:"180x180",href:S},{rel:"icon",type:"image/png",sizes:"192x192",href:T},{rel:"icon",type:"image/png",sizes:"256x256",href:A},{rel:"icon",type:"image/png",sizes:"512x512",href:M},{rel:"icon",href:"/favicon.ico"}],jsonLd:{"@context":"https://schema.org","@type":"Person",name:"Zack MacTavish",alternateName:["Zachary MacTavish","Zack MacTavish Art","Zachary MacTavish Art"],url:r,sameAs:p}}),t.jsx("h1",{style:Z,children:"About Zack MacTavish"}),t.jsxs(d,{$spacing:"spacious",style:{position:"relative"},children:[t.jsx(c,{splitSize:"medium",imageMaxHeight:"500px",imageSrc:B,imageWebp:l,imageWebpSet:`${E} 640w, ${H} 960w, ${l} 2200w`,imageAvif:m,imageAvifSet:`${G} 640w, ${C} 960w, ${m} 2200w`,imageSizes:"(max-width: 900px) 100vw, 40vw",imageAlt:"Portrait of Zack MacTavish",imageWidth:960,imageHeight:960,imageLoading:"eager",imageDecoding:"sync",imageFetchPriority:"high",children:t.jsx(Q,{children:"Zachary MacTavish is a multidisciplinary artist exploring memory, place, and personal history through painting, textile, collage, and print. Having moved over twenty times across six states, his practice is rooted in how displacement and movement shape identity over time. His first solo show, Composition, used the composition notebook as a metaphor for self-reflection across environments and personal growth."})}),!o&&t.jsx(K,{$visible:e,children:t.jsx(X,{})})]}),t.jsx(d,{style:{backgroundColor:"var(--surface-secondary)"},children:t.jsx(c,{splitSize:"medium",imageMaxHeight:"500px",imageSrc:q,imageWebp:F,imageAvif:N,imageAlt:"Installed quilt from the Dwelling series",children:t.jsx(te,{children:"His current work shifts focus from transition to permanence: the homes, families, and communities that endure across a life in motion. Working in quilting, embroidery, collage, painting, and an artist book, MacTavish archives personal and familial histories through fiber and stitch, treating the domestic and inherited as subjects worthy of preservation."})})}),t.jsx(ie,{children:t.jsxs(ae,{children:[t.jsxs(oe,{children:[t.jsx(re,{children:"Thanks for stopping by"}),t.jsx(ne,{children:"I built this website. Check out my design portfolio."}),t.jsx(se,{href:"https://mactavish.xyz",target:"_blank",rel:"noopener noreferrer",children:"View Portfolio"})]}),t.jsx(de,{children:f&&x?t.jsx(a.Suspense,{fallback:null,children:t.jsx(O,{})}):t.jsx(_,{style:{width:"100vw",height:"70vh",objectFit:"cover"},imgStyle:{width:"100vw",height:"70vh",objectFit:"cover"},src:D,webpSrc:I,avifSrc:L,alt:"Pop-art portrait",width:3706,height:3706,loading:"lazy",decoding:"async"})})]})})]})},fe=Object.freeze(Object.defineProperty({__proto__:null,NewSection:R,QuiltContainer:J,QuiltImage:U,QuiltText:ee,default:ce},Symbol.toStringTag,{value:"Module"}));export{fe as A,R as N,D as b};
