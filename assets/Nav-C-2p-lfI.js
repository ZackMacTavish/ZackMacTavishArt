...
`;function $({hidden:u=!1}){const[h,x]=i.useState(()=>typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(max-width: 900px)").matches),[l,n]=i.useState(!1);return i.useEffect(()=>{if(typeof window>"u"||typeof window.matchMedia!="function")return;const o=window.matchMedia("(max-width: 900px)"),d=()=>{x(o.matches),o.matches||n(!1)};return d(),o.addEventListener("change",d),()=>{o.removeEventListener("change",d)}},[]),i.useEffect(()=>{if(!l)return;const o=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=o}},[l]),u?null:e.jsxs(j,{children:[e.jsx(s,{to:"/",style:{cursor:"none"},children:e.jsx(F,{src:b})}),e.jsxs(X,{children:[e.jsxs(E,{children:[e.jsxs(g,{children:[h?e.jsx(m,{role:"button",tabIndex:0,onClick:()=>n(!0),onKeyDown:o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),n(!0))},style:{cursor:"pointer"},children:"Art"}):e.jsx(m,{children:"Art"}),e.jsxs(Y,{children:[e.jsx(r,{to:"/dwelling",children:"Dwelling"}),e.jsx(r,{to:"/composition",children:"Composition"}),e.jsx(A,{}),e.jsx(r,{to:"/printmaking",children:"Printmaking"}),e.jsx(r,{to:"/photography",children:"Photography"}),e.jsx(r,{to:"/3d",children:"3D + Graffiti"})]})]}),e.jsx(g,{children:e.jsx(S,{to:"/About",children:"About"})})]}),e.jsxs(M,{children:[e.jsx(C,{}),e.jsx(z,{}),e.jsx(L,{}),e.jsx(v,{}),e.jsx(y,{})]})]}),h&&l?e.jsxs(N,{children:[e.jsx(O,{type:"button","aria-label":"Close menu",onClick:()=>n(!1),children:"×"}),e.jsx(a,{to:"/dwelling",onClick:()=>n(!1),children:"Dwelling"}),e.jsx(a,{to:"/composition",onClick:()=>n(!1),children:"Composition"}),e.jsx(a,{to:"/printmaking",onClick:()=>n(!1),children:"Printmaking"}),e.jsx(a,{to:"/photography",onClick:()=>n(!1),children:"Photography"}),e.jsx(a,{to:"/3d",onClick:()=>n(!1),children:"3D + Graffiti"}),e.jsx(a,{to:"/about",onClick:()=>n(!1),children:"About"})]}):null]})}export{$ as default};
